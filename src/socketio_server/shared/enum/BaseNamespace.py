"""
BaseNamespace - Dataclass-based namespace system cho SocketIO Server
...
class BaseNamespaces:
    """
    Base namespaces chung cho mọi SocketIO server.

    Các server cụ thể sẽ kế thừa class này và thêm namespaces riêng.
