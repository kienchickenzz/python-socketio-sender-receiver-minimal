"""
KafkaConsumerFactory - Factory để tạo KafkaConsumer cho emit handlers
...
class KafkaConsumerFactory:
    ...
    def create(self, handler: IEmitHandler) -> KafkaConsumer:
        """
        Tạo KafkaConsumer cho main handler.

        Args:
            handler (IEmitHandler): Handler với topic và group
