...
from src.socketio.socketio_client.shared.enum.BaseEvent import SocketEvent, BaseEvents
from src.socketio.socketio_client.shared.enum.BaseNamespace import Namespace
